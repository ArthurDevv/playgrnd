...
class Pixel2XL extends StatefulWidget {
  @override
  _Pixel2XLState createState() => _Pixel2XLState();
}

class _Pixel2XLState extends State<Pixel2XL> {
  @override
  Widget build(BuildContext context) {
    Color glossPanelColor = pixels[2].colors['Gloss Panel'];
    Color mattePanelColor = pixels[2].colors['Matte Panel'];
    Color fingerprintSensorColor = pixels[2].colors['Fingerprint Sensor'];
    Color logoColor = pixels[2].colors['Google Logo'];
